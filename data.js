...
// Booking has a TimeBooked (which includes the date and time for a meeting)
const Booking = sequelize.define("Booking", {
    timeBooked: Sequelize.DATE
});
...
// A User can have one Room Booking
User.hasOne(Booking);
// A Room can be booked for different times
