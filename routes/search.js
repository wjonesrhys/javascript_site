...
router.get("/", function(req, res) {
    ...
    } else if (req.query.type.toLowerCase() === "room") {
        findAll(db.Room, getSearchParams(req.query, ["name"]), res);
    } else if (req.query.type.toLowerCase() === "booking") {
        findAll(db.Booking, getSearchParams(req.query, ["bookingTime"]), res);
    } else {
        res.end();
    }
});
